...
Running a generator:
    ...
    yo angjs:directive my-awesome-directive
    yo angjs:partial my-partial
    yo angjs:service my-service
    yo angjs:filter my-filter
    yo angjs:module my-module
    yo angjs:modal my-modal
...
Submodules allow you to more explicitly separate parts of your application.  Use the `yo angjs:module my-module` command and specify a new subdirectory to place the module into.  Once you've created a submodule, running other subgenerators will now prompt you to select the module in which to place the new component.
...
-------------
###### generator-angjs
* 5/5/2015 - dev - Changes to structure, Gruntfile and less file placements.
...
* 9/06/2013 - V1.0.4 - Fixed templating issue with generated specs for `yo angjs:service` subgenerator.
